const Map<String, String> en = {
  ...
  "user_name": "User Name",
  "login_identifier_label": "Username / Mobile Number",
  "login_identifier_hint": "Enter username or mobile number",
  "login_identifier_helper": "Use your username or digits-only mobile number",
  "password": "Password",
  "login": "Login",
  ...
  "create_access_code_desc":
      "Set a private 4-digit code for this child. It can be viewed by the child and managed by the parent.",
  "access_code_private_hint": "Keep this code private and easy to remember",
  "access_code_required": "Access code is required",
  "access_code_four_digits": "Access code must be exactly 4 digits",
  "store": "Store",
  "back": "Back",
  "next": "Next",
  "upload": "Upload",
  ...
  "mobile_number_10_digits": "Mobile number must be exactly 10 digits",
  "government_id": "Government Id",
  "date_of_birth": "Date of Birth",
  "address": "Address",
  "allergies": "Allergies",
  "optional": "Optional",
  "enable_access_code": "Enable access code",
  "enable_access_code_desc": "Turn the access code requirement on or off for this child.",
  ...
  "enter_otp": "Enter OTP",
  "otp_four_digits": "OTP must be 4 digits",
  ...
  "view_and_update": "Manage",
  "manage_child_access_code": "View or update this child's code",
  "access_code_view_desc":
      "This 4-digit code is used by the child for secure account access.",
  "update_access_code": "Update access code",
  "update_access_code_desc": "Choose a new 4-digit code for this child.",
  "access_code_updated": "Access code updated successfully",
  "access_code_update_failed": "Unable to update access code",
  "show": "Show",
  "hide": "Hide",
  "wallets": "Wallets",
  ...
  "min_recharge_error": "Minimum recharge amount is @amount SAR",
